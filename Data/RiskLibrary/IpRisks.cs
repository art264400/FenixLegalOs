...
public static class IpRisks
{
    public static readonly IReadOnlyList<RiskDefinition> All = new List<RiskDefinition>
    {
        ...
        new() {
            ...
            SectionId = "ip",
            Modules = new() { "ip" },
            Title = "Принадлежность ключевого продукта не подтверждена",
            Finding = "Продукт уже используется или готовится к запуску, но нет достаточного документального подтверждения прав на его ключевые элементы.",
            ...
            Recommendation = "Составить перечень ключевых элементов продукта, собрать договоры авторского заказа или передачи прав и закрыть выявленные разрывы.",
            AffectedDimensions = new() { "overall_rights" },
            Recommendations = new() {
                "Составить перечень ключевых элементов продукта и их авторов.",
                "Собрать договоры и документы, подтверждающие закрепление прав.",
        ...
        new() {
            ...
            Finding = "Один или несколько основателей создавали продукт, но передача необходимых прав оформлена не полностью.",
            WhyItMatters = "При уходе, конфликте или раунде инвестор может потребовать подтверждения, вправе ли проект свободно распоряжаться кодом.",
            Recommendation = "Оформить соглашения о передаче прав (IP Assignment) от основателей в компанию.",
            ...
            Recommendations = new() {
                ...
                "Оформить передачу недостающих прав в компанию."
            },
        ...
        new() {
            ...
            Finding = "Внешний специалист участвовал в создании продукта, но существующие документы не позволяют уверенно подтвердить принадлежность проекту всего созданного результата.",
