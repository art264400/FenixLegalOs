      ...
      '<section class="hero" id="about">' +
        '<div class="hero-flex">' +
          '<div class="hero-copy">' +
            ...
            '<p class="sub">Первичная юридическая диагностика технологической компании.<br>Ответьте на понятные вопросы о том, как устроен ваш бизнес, и получите оценку юридической готовности, карту рисков и понятный план действий.<br>Система покажет, что уже выстроено хорошо, где есть слабые места и что стоит исправить в первую очередь.</p>' +
          '</div>' +
        ...
        '<div class="synthesis-section">' +
          '<div class="synthesis-demo">' +
            '<div class="synth-nodes-grid">' +
              '<div class="synth-node"><span>👤</span> <strong>Два сооснователя</strong></div>' +
              '<div class="synth-node"><span>⚖️</span> <strong>Доли 50 / 50</strong></div>' +
              '<div class="synth-node"><span>🤝</span> <strong>Решения только совместно</strong></div>' +
              '<div class="synth-node"><span>⚠️</span> <strong>Нет deadlock-механизма</strong></div>' +
            '</div>' +
            '<div class="synth-connector">⚡ Синтез связей алгоритмом SLS ↓</div>' +
            '<div class="synth-result-card">' +
              '<span class="synth-result-badge">🔴 Выявленный риск · CRITICAL</span>' +
              '<strong>Высокий риск тупика в управлении (Deadlock)</strong>' +
              '<p>Ни один ответ по отдельности не является нарушением, но их комбинация создаёт критическую уязвимость для бизнеса и инвесторов при первом же споре.</p>' +
            '</div>' +
          '</div>' +
          '<div class="synthesis-copy">' +
            '<h2>Как работает синтез связей в SLS</h2>' +
            '<p>Система анализирует не отдельные ответы, а их сочетание и взаимосвязь — чтобы выявлять юридически слабые конфигурации бизнеса, которые могут долго оставаться незаметными.</p>' +
            '<div class="synth-example-box">' +
              '<strong>Например:</strong><br>' +
              'Два сооснователя · 50/50 · ключевые решения только совместно · нет заранее согласованного способа выйти из тупика.<br><br>' +
              'SLS распознает это не как четыре отдельных ответа, а как единый риск для управления компанией.' +
            '</div>' +
        ...
        '<div class="trust-firm-section">' +
          '<div class="trust-firm-copy">' +
            ...
            '<p><strong>FENIX SLS</strong> создан на базе реальной практики <strong>FENIX LAW</strong> – бутиковой юридической фирмы по сопровождению технологических компаний, основателей и инвестиционных сделок.</p>' +
            '<p>В основе системы настоящие юридические ситуации, с которыми сталкиваются стартапы и растущие компании: структура, права на продукт, команда, данные и подготовка к инвестициям.</p>' +
            '<p style="color:var(--gold); font-weight:500;">Этот опыт преобразован в системную диагностику, которая помогает увидеть слабые места бизнеса до того, как они станут проблемой.</p>' +
          '</div>' +
          '<div class="trust-firm-logo-wrap">' +
